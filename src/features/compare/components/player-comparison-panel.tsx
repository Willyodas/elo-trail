...
export function PlayerComparisonPanel({
  ...
  return (
    <section
      aria-labelledby="player-comparison-heading"
    ...
    >
      ...
      {isLoading ? (
        ...
        <>
          <div className="max-w-full min-w-0 overflow-hidden rounded-xl border border-black/10 bg-white p-3 sm:p-5 dark:border-white/10 dark:bg-black/10">
            <EloComparisonChart
              players={[
                {
